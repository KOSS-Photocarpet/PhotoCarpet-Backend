...
public class ExhibitionService {
    private final MoodRelationTestRepository moodRelationTestRepository;
    ...
    public Exhibition setCustomMoods(List<String> customMoodNames, Exhibition exhibition) {
        ...
        for(String customMoodName: customMoodNames) {
            ...
            if(customMood == null) {
                ...
                customMoodTestRepository.save(customMood);
            }
            MoodRelation moodRelation = MoodRelation.builder()
                    .customMood(customMood)
                    .exhibition(exhibition)
                    .build();
            moodRelationTestRepository.save(moodRelation);
